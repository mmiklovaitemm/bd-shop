...
const translations = {
  ...
  lt: {
    ...
    productNames: {
      ...
      "Core Bracelet": '"Core" apyrankė',
      "Cut Ring": '"Cut" žiedas',
      "Dot Necklace": '"Dot" vėrinys',
      "Drift Ring": '"Drift" žiedas',
      "Earth Ring": '"Earth" žiedas',
      "Echo Ring": '"Echo" žiedas',
      "Fall Necklace": '"Fall" vėrinys',
      "Fluid Ring": '"Fluid" žiedas',
      "Fold Ring": '"Fold" žiedas',
      "Forever Ring": '"Forever" žiedas',
      "Impressa Ring": '"Impressa" žiedas',
      "Light Earrings": '"Light" auskarai',
      "Loop Earrings": '"Loop" auskarai',
      "Melt Earring": '"Melt" auskaras',
      "Pearl Necklace": '"Pearl" vėrinys',
      "Point Earrings": '"Point" auskarai',
      "Pure Earrings": '"Pure" auskarai',
      "Pure Ring": '"Pure" žiedas',
      "Ridge Ring": '"Ridge" žiedas',
      "Sol Earrings": '"Sol" auskarai',
      "Special Ring": '"Special" žiedas',
      "Stack Ring": '"Stack" žiedas',
      "Still Ring": '"Still" žiedas',
      "True Ring": '"True" žiedas',
      "Um Ring": '"Um" žiedas',
      "Wave Ring": '"Wave" žiedas',
      '"Earth" ring': '"Earth" žiedas',
      '"Cut" ring': '"Cut" žiedas',
      '"Dot" necklace': '"Dot" vėrinys',
